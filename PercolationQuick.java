...
public class PercolationQuick {
    ...
    public PercolationQuick(int n) {
        ...
        this.n = n;
        grid = new int[n][n];
        quf = new QuickUnionUF(n * n+2); //the 2 additional slots are for the virtual top and bottom
   ...
   /* private boolean ajacent(int x, int y, int x2, int y2) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PercolationQuick p = new PercolationQuick(size);
